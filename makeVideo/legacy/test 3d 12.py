...
def calculateRotation(A, B):#, lenght):
    ...
    X,Y,Z = getMidPointXYZ(A,B)
    midPointRadius = getRadius(X, Y, Z)
...
def generateLine(a,b,resolution):
    ...
    for iterator in range(resolution):
        ...
        x,y,z = getProjectedPoint(xSemiPoint,ySemiPoint,zSemiPoint)
        phi, theta, _ = cartesianToSpherical(x,y,z)
        line.append(Point(phi,theta))
...
def main():
    ...
    line = generateLine(Point(0,0),Point(50,50),20)
    line2 = generateLine(Point(90,90),Point(50,50),20)
    line3 = generateLine(Point(90,90),Point(0,0),20)
    ...
    while(1):
        ...
        plotVeinByPoints(ax, veinRadius, heartRadius, line)
        plotVeinByPoints(ax, veinRadius, heartRadius, line2)
        plotVeinByPoints(ax, veinRadius, heartRadius, line3)
